// Composites the Broward County Locksmith logo onto any source image as a
...
const FRAME_COLOR    = { r: 31, g: 124, b: 180, alpha: 1 }; // #1f7cb4 Broward County Locksmith blue
